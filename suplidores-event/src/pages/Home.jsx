        ...
        <section className="relative py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-white p-2 rounded-full shadow-lg flex items-center max-w-2xl mx-auto flex-wrap sm:flex-nowrap">
                ...
                <button
                  className="text-white py-3 px-6 rounded-full font-medium hover:opacity-90 transition-opacity w-full sm:w-auto mt-2 sm:mt-0"
                  style={{
